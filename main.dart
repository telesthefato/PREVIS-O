...
void main() {
  runApp(const PrevisaoApp());
}

class PrevisaoApp extends StatelessWidget {
  const PrevisaoApp({Key? key}) : super(key: key); // Adicionando key
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const PrevisaoPage(),
    );
  }
}

class PrevisaoPage extends StatefulWidget {
  const PrevisaoPage({Key? key}) : super(key: key); // Adicionando key
